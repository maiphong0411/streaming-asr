...
if __name__ == '__main__':
    ...
    parser.add_argument('--resample',
                        ...
                        default=16000,
                        help='segments file')
    parser.add_argument('--wav_file', default='/vinbrain/phongmt/wenet/wenet/examples/foo/s0/data/valid/wav.scp', help='wav file')
    parser.add_argument('--text_file', default="/vinbrain/phongmt/wenet/wenet/examples/foo/s0/data/valid/text", help='text file')
    parser.add_argument('--shards_dir', default='/vinbrain/phongmt/wenet/wenet/examples/foo/s0/valid_shard_data' ,help='output shards dir')
    parser.add_argument('--shards_list', default='valid_shard_data.list', help='output shards list file')
